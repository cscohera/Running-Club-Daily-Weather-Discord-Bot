...
# The Bot started off very simple with me learning how to create a discord bot

I wanted to get my data from UCF's weather system Thorguard as that determines if we have practice or not. 
